 ...
 * choosing the segment that matches the default stores `""` rather than the value, so the
 * default is still sent by nobody and defined only in one place. See `api/schemaForm.ts`
 * for why that rule is worth this much care.
 */
