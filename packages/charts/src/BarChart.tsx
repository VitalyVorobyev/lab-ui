/**
 * Horizontal stacked bars — a per-category breakdown.
 *
 * Horizontal because the categories are free text — a defect type, a part family — and a
 * vertical axis would either truncate them or turn them sideways. Stacked because the
 * usual question is "of this category, how many landed in each outcome", which is a
